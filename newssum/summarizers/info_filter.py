...
class InfoFilter():
    ...
    def get_best_sents(self, parser, w_threshold=400):
    ...
    def evaluate_summarizer(self, parsers):
        ...
        def get_rouges(parser):
            # print("Get rouges...")
            # print(parser)
            selected_sents = self.get_best_sents(parser)
    ...
    def get_train_val_test_data(train_parsers, val_parsers, test_parsers):
        ...
        def preprocess(parsers, mode="train"):
            ...
            # randomly select same size of negative samples as positive samples to avoid imbalance
            # X = X_initial.copy()
            # y = y_initial.copy()
...
if __name__ == "__main__":
    ...
    # filter.evaluate_summarizer(test_parsers)
    #
    # rouges = []
